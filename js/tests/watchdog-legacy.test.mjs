...
// skills/standing/references/ (graph nks-dev: #4058, #4059). LEGACY: these files are
// kept for watches on the native transport that were started before the bridge
// took over the socket (#4336) — an update removed them and live watches died
// re-arming. They stay until such watches are gone. They have no
...
const DIR =
  process.env.ISKRON_WATCHDOG_DIR || join(HERE, "..", "..", "skills", "standing", "references");
