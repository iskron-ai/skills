...
export const TAKE_PATH =
  ...
  "и поднятый следом сторож его не уносит: занятость дальше публикуется обычным ходом (наблюдено на сборке 6.10.1 — два вызова подряд при живом стороже; путь take наблюдала сторона nks-mcp на своей сборке). Прежний держатель получит закрытие 4000 " +
