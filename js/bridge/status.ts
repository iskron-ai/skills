...
export const TAKE_PATH =
  ...
  "и поднятый следом сторож, забравший сокет обратно, его не уносит — занятость дальше публикуется обычным ходом (наблюдено стороной nks-mcp). Прежний держатель получит закрытие 4000 " +
