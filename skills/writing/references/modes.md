...
Пара chanda | upeksha (решился — adhimoksha, отпустил — visarjana: там различать нечего) на состоянии (sachverhalt) или деянии, к которому воля не отрицательна, vartamana/anagata — один вопрос: **держится намерением или устройством?** Случай — цепь мержа манифестов: слияние кладёт их в ствол, гейт проверяет набор перед этим. Состоянию: возникает ли само? («в стволе» возникает от слияния — upeksha; «набор проверен» никто не обязан гонять — chanda). Деянию: продолжалось бы, если бы никто не настаивал? (да — upeksha; нет — chanda). Фальсификатор: механизм стал требовать сам — chanda лжёт, ставь upeksha. Образцы ниже с Vi/Ad/Vs он не трогает: отвергаемое, решённое, отпущенное — не его вопрос; на vikalpa не задаётся; на других родах данности и на роли не проверен.
