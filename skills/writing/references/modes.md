...
Воля на феномене: спроси, **возникает ли состояние само**. Возникает от устройства (слияние → «в стволе», применение → «применён») — upeksha честна. Само не возникает (проверка, которую никто не обязан гонять) — состояния добиваются, chanda. Фальсификатор: механизм стал требовать его сам — chanda лжёт, ставь upeksha.
