...
Воля на феномене и крие — один вопрос: **держится намерением или устройством?** Состоянию: возникает ли само? (слияние → «в стволе» — upeksha; «проверен» никто не обязан — chanda). Деянию: продолжалось бы, если бы никто не настаивал? (да — upeksha; нет — chanda). Фальсификатор: механизм стал требовать сам — chanda лжёт, ставь upeksha. На роли не проверено.
