...
Пара chanda | upeksha на *желаемом* состоянии (sachverhalt) или деянии, vartamana/anagata — один вопрос: **держится намерением или устройством?** Состоянию: возникает ли само? (слияние → «в стволе» — upeksha; «проверен» никто не обязан — chanda). Деянию: продолжалось бы, если бы никто не настаивал? (да — upeksha; нет — chanda). Фальсификатор: механизм стал требовать сам — chanda лжёт, ставь upeksha. Образцы ниже с Vi/Ad/Vs он не трогает: отвергаемое, решённое, отпущенное — не его вопрос; на vikalpa не задаётся; на других родах данности и на роли не проверен.
