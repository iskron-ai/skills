...
Граница графа топологична: крия на краю графа легальна без ahara — ни один детектор его не требует, ни один маркер не глушит. `attrs.boundary="init"` живёт только как положительная метка потребителя-с-входа, никогда как глушитель натяжений.
