...
**Контракт: `1`.** Шаг 7 штампует это число в каждый записанный `AGENTS.md`. Увеличивай на единицу только когда перемена здесь или в скелете делает уже сгенерированный файл *неверным* — секция добавлена, переименована или изъята, ритуал изменён, имя тула выпало; никогда — ради формулировок. Репо с меньшим штампом получает полную дугу, и ты называешь контракт, из которого пришёл его конфиг.
