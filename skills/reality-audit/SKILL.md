---
name: reality-audit
description: "Терминальная приёмка поведенческой работы — свидетельствование реальностью. Используй после последней содержательной правки, до слов verified/done/green; после поправок владельца или упавших фальсификаторов; когда тест вернул ненулевой код или смешанный вывод. Триггеры: reality audit, «проверка реальностью», «проверь канонический артефакт», «докажи, что работает», tests passed. Заморозь утверждения → канонический носитель и фальсификатор → фейл-клоузд лестница → один вердикт на утверждение. Скретч и печатный вывод — provisional."
---
