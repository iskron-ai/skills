---
name: reality-audit
description: "Терминальная приёмка поведенческой работы — свидетельствование реальностью. Используй после последней содержательной правки, до слов verified/done/green; после поправок владельца или упавших фальсификаторов; когда тест/тул вернул ненулевой код или смешанный вывод, который надо суммировать. Триггеры: reality audit, «проверка реальностью», «проверь канонический артефакт», «докажи, что работает», tests passed. Заморозь несущие утверждения → канонический носитель и исполняемый фальсификатор → фейл-клоузд лестница свидетельств → один правдивый вердикт на утверждение. Скретч-артефакты и печатные наблюдения — provisional."
---
