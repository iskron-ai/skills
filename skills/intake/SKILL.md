...
- **Не iskronify** — iskronify проецирует *derived-конфиг* (аудит AGENTS.md, «не дублировать граф»); intake вносит *содержание*. Разные акты; iskronify может *композировать* intake, предлагая засев в конце бутстрапа.
