...
**Источник-независимость — весь смысл.** Источник — это *адаптер*; дисциплина впуска ниже — одна. `product-roadmap` композирует этот слой с GitHub-адаптером; будущий засев repo-boost или интейк документации — с другим. Не впаивай источник в дисциплину.
...
- **Не repo-boost** — repo-boost проецирует *derived-конфиг* (аудит AGENTS.md, «не дублировать NKS»); intake вносит *содержание*. Разные акты; repo-boost может *композировать* intake, предлагая засев в конце бутстрапа.
