...
- **Не iskronify** — iskronify проецирует *derived-конфиг* (аудит AGENTS.md, «не дублировать NKS»); intake вносит *содержание*. Разные акты; iskronify может *композировать* intake, предлагая засев в конце бутстрапа.
