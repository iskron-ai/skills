...
- **Не сверка реальности** — claim-аудит сверяет прозу с графом (первая ступень сверки); поведенческие заявления сверяются с миром на каноническом носителе — дисциплина «Сверка реальностью» скилла on-duty. Совпадение с графом не рождает поведенческой уверенности.
