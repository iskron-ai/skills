...
| `clears itself by waiting … retry after ~Ns` | придержанный грант: ничего не применилось, но и повтор сейчас не пройдёт | подожди названное, не чини |
