...
Канонический шаблон подсекции `### Workflow-suite interop (superpowers)`, которую Шаг 7 iskronify проецирует в `AGENTS.md` целевого репо (в конец `## Жизненный цикл сессии`), когда superpowers обнаружен и пользователь согласился на Шаге 1. Деплоируемая секция — огороженный блок ниже; чек-лист перепроверки после него остаётся здесь и не деплоится никогда.
