...
- **Зонт — ступень, а не папка.** У него своя грубая связь: он применяет, ест или даёт целое либо род того, что дети берут по частям и видам (принцип веера и ступеней — **writing**, Решение 5); дети отвечают на его «как именно?». Стена — не число детей, а неразличённая ширина: сто крий под тремя зонтами со своими связями — веер шириной три, и зов к нему не «раздели», а «назови среднее». Где при уточнении деяния сменилась мотивация — среднее есть суб-роль, делатель уточнённых (`group`). Среднее у каждого рода веера своё: у феномена со многими деяниями — зонтичная крия либо части и виды феномена; у роли со многими деяниями — зонтичная крия того же делателя или суб-роль; у якоря со многими вопрошаниями — превращение, которое они движут, или якорь груб и вопрос пересаживается на точный узел; у контура со многими феноменами — вложенный контур или целое-феномен; у превращения со многими частями — суб-превращение (по канону; зов и показ поверхности — после её релиза, читай из ответа).
