...
Заявление о прибытии превращения — поведенческое утверждение: прежде чем предложить владельцу закрытие, оно сверяется реальностью с объявленной ступенью (свежая пратьякша на каноническом носителе, не согласие карты с самой собой — дисциплина сверки в on-duty).

## Приёмка

- Срабатывает на сборочные формулировки («собери граф», «что тут по сути происходит», «повестка»).
- Пилотная сборка реального графа проходит насквозь: orient → поле растриажено → композиты названы-или-в-повестке → 形 (карта превращений) произведена → импульс поднят.
