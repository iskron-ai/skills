...
- [ ] Секция «чтение поля» на месте: роли-драйверы (+ рантайм-цели), структурные риски из натяжений, карта фигура-на-почве — каждый NKS-термин глоссирован по-простому при первом употреблении.
