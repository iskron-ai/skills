...
- **Граф — после свидетельства, никогда не вход.** Сначала вердикты и последние правки артефактов, затем одно терминальное обновление узла. Состояние графа — не аргумент вердикта; структурное здоровье графа не повышает поведенческий вердикт; прозой поведенческий провал не закрывается.
