...
Строить карту *из* поля — кластеризовать вимарши в bianhua, упорядочивать превращения — скилл **assembly**. Этот скилл решает судьбу каждой вимарши; assembly делает проход по графу.
...
- **Не карта графа** — кластеризация вимарш в bianhua, порядок, 形 → **assembly**.
