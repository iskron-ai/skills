...
ДЕЛАЙ:
  1. Назови цель как sachverhalt(anagata+chanda). Целевое состояние — владельца:
     ...
     Кто её берёт? Тот, ради кого она, — крия отдачи: ahara на цель, без utpatti,
     актор 主/客. Правый край стоит прежде рекурсии влево
  ...
  4. Рекурсия, пока не упрёшься в данность извне — и тогда крия наблюдения:
...
| relay-gap | у феномена ahara, нет utpatti | Добавь производящую крию; феномен приходит извне — крия наблюдения (utpatti без ahara) в холоне внешней системы |
