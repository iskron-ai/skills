---
name: design
description: "Используй, когда просят спроектировать систему, компонент или фичу и доступны NKS-тулы: «спроектируй», «давай продумаем», «архитектура», «нужен дизайн», design, plan the system, «жц», «крия», «эстафета», «записать в NKS», «положить в граф». Также в моменты решений («мы решили», persist this design) и после брейнсторма — граф превращает дизайн в запись; и когда разговор поворачивает к строительству («что будем строить?»). Не для имплементации уже принятой конкретной спеки, рутинных фиксов и кодинга без открытого структурного выбора."
---
