...
Особый статус: **methodology-work живёт только здесь** — из сиблинг-репозитория скиллов он удаляется; апстрима для него больше нет, канон — сам реалм methodology.

Продуктовые скиллы без единого канонического ориентира: **repo-boost** и **minding** — их источник — сиблинговые такты (прообразы repo-boost и minding у апстрима) + компоненты канона (аудит-классификация, кристаллизация в §2 minding, дисциплина холонных вопросов); сверять при обновлениях сиблинга, ре-деривация по-русски с обогащением семантическими гнёздами.
