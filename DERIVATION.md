...
| Сверка реальности: ступени (граф/мир), свидетель-не-автор (kartṛ→sākṣin), фальсификатор заранее, канонический носитель, потолки родов; промежуточная дисциплина | #157, #503, #504, #469, #507, #491 (+ bildung промежуточного решения) | on-duty → §3b «Сверка реальностью»; intake → шаг 5; integrity → routing-строка; repo-boost → слот Reality | ступень, носитель, вердикты или потолок меняются; bildung кристаллизуется |
