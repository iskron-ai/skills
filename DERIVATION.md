...
| Язык артикуляции отношений МЕЖДУ ЖЦ (π-риторика исчисления процессов или собственные средства графа) — ОТКРЫТ | #599 | likbez → абзац «Порядок событий» (назван открытым, средства графа как рабочий язык) | вимарша закрыта: выбор языка зафиксирован принципом |
