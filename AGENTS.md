...
## Что когда обновлять
- `AGENTS.md` — когда меняются соглашения репо, команды или набор скиллов, — и по перевёрнутому умолчанию: **узнаваемое из узла графа сюда не пишется**; файл держит только нужное до того, как сессия дотянется до графа (абзац здесь — налог на каждую будущую сессию).
