...
отвечает списком графов. Дальше ведёт дверь: графов нет — спросит имя первого графа,
создаст его и доведёт исходную просьбу до первой записи; репозиторий без `AGENTS.md` —
...
Установка кончается первой записью в граф пользователя, а не подключением.
